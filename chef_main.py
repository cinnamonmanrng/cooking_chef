...
version_id = "build:22/WINDOWS_17/03/23 | Please email: ccg.issues@gmail.com or join our discord (link on github page) for any issues you may encounter, Thank you!"
...
recipe6 = Recipe("\033[32;1mMargherita Pizza\033[0m", 25 * 14, 1, 14, 1, "rec006")
recipe7 = Recipe("\033[32;1mVictoria sponge cake\033[0m", 25 * 10, 1, 10, 1, "rec007")
recipe8 = Recipe("\033[32;1mRoasted potatoes\033[0m", 25 * 18, 1, 18, 1, "rec008")
recipe9 = Recipe("\033[32;1mChicken stir fry\033[0m", 25 * 15, 1, 15, 1, "rec009")
recipe10 = Recipe("\033[32;1mTomato pasta\033[0m", 25 * 14, 1, 14, 1, "rec010")
recipe11 = Recipe("\033[34mPeanut butter brownies\033[0m", 25 * 20, 2, 20, 1, "rec011")
recipe12 = Recipe("\033[34mGrilled sausages", 25 * 19, 2, 19, 1, "rec012")
...
equip3 = Equipment("\033[32mMystery potato flavouring\033[0m", f"Decreases {recipe1.name}'s cooking time by 5 seconds", 0, 5, 1, "eq003") # only for rec001
...
Equipment.equipbox2_inv.append(equip7)
...
Recipe.lootbox2_inv.append(recipe11)
